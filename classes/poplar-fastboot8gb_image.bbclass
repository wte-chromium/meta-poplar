...
IMAGE_TYPEDEP_poplarfastboot8gb = "ext4 tar"
BOOTOPTIONS_PARTITION_SIZE = "2048"

do_image_poplarfastboot8gb[depends] = " \
...
IMAGE_CMD_poplarfastboot8gb () {
    ...
    echo "bootargs=androidboot.selinux=permissive androidboot.serialno=0123456789 androidboot.optimize=true" >> ${WORKDIR}/STARTUP_ANDROID
    ...
    echo "bootargs=androidboot.selinux=disabled androidboot.serialno=0123456789 androidboot.optimize=true" >> ${WORKDIR}/STARTUP_ANDROID_DISABLE_LINUXSE
